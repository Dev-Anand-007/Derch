...
import { Eye, EyeOff, Mail, Lock, User, ArrowRight, Github, Chrome, IterationCcw } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            >
                ...
                <motion.div className='text-center mb-8'
                    ...
                    <motion.h1
                        className='text-5xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-tansparent mb-2'
                ...
                {/* Auth Card  */}
                <motion.div
                    className='bg-white rounded-3xl p-8 shadow-2xl shadow-blue-500/10 border border-gray-10 relative overflow-hidden'
                    variants={itemVariants}
                >
                        ...
                        <div className='flex bg-gray-100 rounded-2xl p-1.5 mb-8'>
                            <motion.button
                                className={`flex-1 py-3 px-6 rounded-xl text-sm font-semibold transition-all duration-300 ${isLogin
                                    ?
                                    'bg-white text-blue-600 shadow-lg shadow-blue-50/20' : 'text-grey-500 hover-text:text-gray-700'
                                    }`}
